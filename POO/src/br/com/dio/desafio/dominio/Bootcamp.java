...
public class Bootcamp {
	...
	@Override
	public int hashCode() {
		return Objects.hash(dataFim, dataInicio, descricao, devsIncritos, nome);
	}
	@Override
	public boolean equals(Object obj) {
		...
		return Objects.equals(dataFim, other.dataFim) && Objects.equals(dataInicio, other.dataInicio)
				&& Objects.equals(descricao, other.descricao) && Objects.equals(devsIncritos, other.devsIncritos)
